...
(function (root, factory) {
    ...
    function CheckImgLoad(imgEl, imgSrc, imgLoadedClass){
        ...
        if(!(imgEl.classList.value.includes('links-with-spaces'))) objImg.src = imgSrc.replace(/'/g, '');
                    ...
                    if (entry.isIntersecting) {
                        ...
                        if ("img" === entry.target.tagName.toLowerCase()) {
                            if (src) {
                                ...
                                CheckImgLoad(entry.target, src, "lazy-loaded");
                            }
                            if (srcset) {
                                entry.target.srcset = srcset;
                                CheckImgLoad(entry.target, srcset, "lazy-loaded");
                            }
                        } else {
